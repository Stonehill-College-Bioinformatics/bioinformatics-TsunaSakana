...
AlignALL <- matchPattern(reversecompquery, ref[[1]], max.mismatch=20)

#Tried to remove all the - and stuff from all the sequences then align them all to the sequence of the reversecompquery. Im not entirely sure what this code did tbh
```
